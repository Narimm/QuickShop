...
public class Economy_Satoshis implements EconomyCore {
    ...
    public Economy_Satoshis() {
        final Plugin plugin = Bukkit.getPluginManager().getPlugin("Satoshis");
        if (plugin == null) {
     ...
     * 
     * @param name
     *            The name of the player. Case insensitive.
     * @param amount
     ...
     *            The name of the player. Case insensitive.
     * @param amount
     *            The amount to take from the player
